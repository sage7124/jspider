...
async function runMerge() {
    ...
    console.log('=========================================');
    const prismaCentral = new client_1.PrismaClient({ datasources: { db: { url: DB_URL_CENTRAL } } });
    const prismaJaya = new client_1.PrismaClient({ datasources: { db: { url: DB_URL_JAYA } } });
    const prismaHanu = new client_1.PrismaClient({ datasources: { db: { url: DB_URL_HANU } } });
    const remoteDbs = [
        ...
        for (const remote of remoteDbs) {
            ...
            for (const ru of remoteUsers) {
                ...
                if (!centralUser) {
                    ...
                    const createData = { ...ru };
                    delete createData.id; // auto increment
...
runMerge();
//# sourceMappingURL=mergeAllData.js.map